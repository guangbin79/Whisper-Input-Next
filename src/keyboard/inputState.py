...
class InputState(Enum):
    ...
    WENET_STREAMING = auto()    # WeNet 本地流式识别中
    ...
    def is_recording(self):
        """检查是否处于录音状态"""
        return self in (InputState.RECORDING, InputState.RECORDING_TRANSLATE, InputState.RECORDING_KIMI, InputState.DOUBAO_STREAMING, InputState.WENET_STREAMING)
